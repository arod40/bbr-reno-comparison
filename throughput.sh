...
python flows.py --fig-num 2 --cong $cong --time $time --bw-net $bw --delay-min $delay_min --delay-inc $delay_inc --maxq $maxq --num-flows $num_flows --time-btwn-flows $time_btwn_flows --flow-type $flow_type --dir $dir
